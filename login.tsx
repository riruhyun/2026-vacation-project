...
function LoginScreen({ email, setEmail, password, setPassword, onSubmit }: LoginScreenProps) {
  return (
    <div
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          onMouseEnter={(e: React.MouseEvent<HTMLButtonElement>) =>
            (e.currentTarget.style.backgroundColor = colors.greenHover)
          }
...
function HomeScreen() {
  ...
  const navItems: string[] = ["홈", "도감", "수집", "프로필"];
